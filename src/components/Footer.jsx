...
const Footer = () => {
  ...
  return (
    <motion.footer 
      ...
      className="bg-primary-blue text-white pt-10 pb-6 border-t-4 border-accent-red" id="contacto"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://www.facebook.com/profile.php?id=61571232704026" target="_blank" rel="noopener noreferrer" className="h-8 w-8 flex items-center justify-center rounded-full bg-blue-900 border border-blue-800 text-blue-300 hover:bg-accent-red hover:text-white hover:border-accent-red transition-all shadow-sm">
                  <Facebook size={14} />
                </a>
                <a href="https://www.instagram.com/skilled_proyectos/" target="_blank" rel="noopener noreferrer" className="h-8 w-8 flex items-center justify-center rounded-full bg-blue-900 border border-blue-800 text-blue-300 hover:bg-accent-red hover:text-white hover:border-accent-red transition-all shadow-sm">
                  <Instagram size={14} />
                </a>
                <a href="https://www.linkedin.com/company/skilled-proyectos-industriales/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="h-8 w-8 flex items-center justify-center rounded-full bg-blue-900 border border-blue-800 text-blue-300 hover:bg-accent-red hover:text-white hover:border-accent-red transition-all shadow-sm">
                  <Linkedin size={14} />
                </a>
              </div>
            </div>
          ...
          {/* Ubicación */}
          <div>
            <h4 className="text-base font-bold mb-4 border-b border-blue-800 pb-1">Ubicación</h4>
            ...
            <div className="rounded-xl overflow-hidden border-2 border-blue-800 shadow-lg mt-2 h-32">
              <iframe 
        ...
        <div className="border-t border-blue-800 pt-6 flex flex-col md:flex-row justify-between items-center text-[10px] sm:text-xs text-blue-400 gap-2">
